...
public class MQConfig {
   ...
   //测试Topic类型
    ...
    public Queue goodsTopicQueue1(){
        return  new Queue(GOODS_TOPIC_QUEUE_1,false);
    }
    @Bean
    public Queue goodsTopicQueue2(){
        return  new Queue(GOODS_TOPIC_QUEUE_2,false);
    }
    @Bean
    public Queue goodsTopicQueue3(){
        return  new Queue(GOODS_TOPIC_QUEUE_3,false);
    }
    ...
    public Queue goodsQueue1(){
        return  new Queue(GOODS_QUEUE_1,false);
    }
    @Bean
    public Queue goodsQueue2(){
        return  new Queue(GOODS_QUEUE_2,false);
    }
    @Bean
